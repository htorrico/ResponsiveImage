...
using ResponsiveImage.Filters;
using ResponsiveImage.Models;

namespace ResponsiveImage.Controllers
{
    [Authorize]
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            //if (ModelState.IsValid && WebSecurity.Login(model.UserName, model.Password, persistCookie: model.RememberMe))
                if (ModelState.IsValid && VerificarPassword(model.UserName,model.Password))
            {
                return RedirectToAction("BSC", "Account");
        ...
        private bool VerificarPassword(string usuario, string contrasena)
        {
            bool result=false;
